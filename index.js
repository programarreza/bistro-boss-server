...
async function run() {
  try {
    ...
    app.post("/payments", async (req, res) => {
      ...
      // Danger: carefully delete each item from the cart
     ...
     * 2. for every menuItems (which is an array), go find the item in menu collection
     * 3. for every item in the menu collection that you found from an payment entry (document)
     * 4.
     */
